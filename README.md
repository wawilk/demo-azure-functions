...
These functions assume you have already created a custom **Content Understanding** endpoint.  
(To create one you typically first create a custom **classifier** and one or more custom **analyzers**)  
